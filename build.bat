...
rem "c:\Program Files\autohotkey\compiler\Ahk2Exe.exe" /out "e:\svn\branches\release\Assist.exe" /in "d:\onedrive\CopyName.ahk" /icon "e:\svn\branches\release\green.ico"

"c:\Program Files (x86)\CreateInstall v4\ci" e:\svn\branches\medicalphoto.ci
rem "c:\Program Files (x86)\CreateInstall v4\ci" e:\svn\branches\medicalphoto_kor.ci
...
rem "C:\Program Files\7-Zip\7z.exe" a E:\SVN\branches\release\setup_kor.zip E:\SVN\branches\release\setup_kor.exe
copy "E:\SVN\branches\release\setup.zip" "\\i5\http\medicalphoto\repo\release\beta\setup.zip"
rem copy "E:\SVN\branches\release\setup_kor.zip" "\\i5\http\medicalphoto\repo\release\beta\setup_kor.zip"
copy "E:\SVN\branches\release\setup.exe" "\\i5\http\medicalphoto\repo\release\beta\setup.exe"
rem copy "E:\SVN\branches\release\setup_kor.exe" "\\i5\http\medicalphoto\repo\release\beta\setup_kor.exe"
