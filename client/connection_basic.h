...
#ifdef _DEBUG
#define FILETRANSFER_TIMEOUT 600
#endif
#ifndef _DEBUG
#define FILETRANSFER_TIMEOUT 15
#endif
...
#ifdef _DEBUG
	  log << MCodeChanger::_CCW(err.c_str()) << log.endl();
#endif
  }
...
//	timer.expires_at(boost::posix_time::second_clock::local_time()+boost::posix_time::seconds(30));
  ...
  {
#ifdef _DEBUG
	  log<<_T("async_read") << MCodeChanger::_CCW(inbound_data_) << _T("\n");
#endif
