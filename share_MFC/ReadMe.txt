========================================================================
    STATIC LIBRARY : share_MFC Project Overview
========================================================================

AppWizard has created this share_MFC library project for you. 

This file contains a summary of what you will find in each of the files that
make up your share_MFC application.
...
StdAfx.h, StdAfx.cpp
    ...
    named share_MFC.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "share_MFC.rc" and a "share_MFC.h" that 
