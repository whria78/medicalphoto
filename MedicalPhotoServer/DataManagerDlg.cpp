...
CDataManagerDlg::CDataManagerDlg(boost::asio::io_service& io_service_, boost::asio::ssl::context& context_,config& c_,CMyCout& l_,CWnd* pParent /*=NULL*/)
	: CDialog(CDataManagerDlg::IDD, pParent)
	,data_manager(io_service_, context_,c_,l_)
	,log_(l_)
	,bStopThread(false)
	,bStartThread(false)
{
