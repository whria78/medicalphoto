<?php die("Access Denied"); ?>#x#a:4:{s:4:"body";s:995:"<div class="item-page">
...
<h3>Han Seung Seog</h3>
<h3>Asan Medical Center, Seoul, Korea, http://derm.amc.seoul.kr</h3>
<h3>I dermatology, <a href="http://whiteipl.com" target="_blank">http://whiteipl.com</a></h3>
<h3><script type='text/javascript'>
 <!--
 var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
 var path = 'hr' + 'ef' + '=';
 var addy82248 = 'whr&#105;&#97;78' + '&#64;';
 addy82248 = addy82248 + 'gm&#97;&#105;l' + '&#46;' + 'c&#111;m';
 document.write('<a ' + path + '\'' + prefix + ':' + addy82248 + '\'>');
 document.write(addy82248);
 document.write('<\/a>');
